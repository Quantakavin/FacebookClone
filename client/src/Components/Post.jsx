...
import { Form, Button, Modal, Spinner, Dropdown, DropdownButton, Image, Container, Row, Carousel } from 'react-bootstrap';
    ...
    <>
      ...
      <Container className="shadow post">
        <div style={{ display: "flex", flexDirection: "row", padding: 5 }} onClick={() => {
          ...
          {props.post.picurl == null ? <LazyLoadImage style={{ marginBottom: 10, flexShrink: 0.2 }} src={profilephoto} width="50px" height="50px" roundedCircle /> : <LazyLoadImage style={{ marginBottom: 10, flexShrink: 0.2 }} src={props.post.picurl} width="50px" height="50px" roundedCircle />}
                      ...
                      return <Carousel.Item>
                        {
                          mediaItem.type == "image" ?
                          <LazyLoadImage effect = {"blur"} width="100%" style={{ marginBottom: 15 }} src={mediaItem.cloudinaryurl} fluid /> :
                            <ReactPlayer controls={true} loop={true} style={{ margin: 15 }} url={mediaItem.cloudinaryurl} />
                        }
                      </Carousel.Item>
                    })
                  }
          ...
          {comments.map(comment =>
            <Container key={comment.commentid} style={{ paddingLeft: 25, paddingRight: 25, paddingTop: 10, paddingBottom: 10 }}>
              <div style={{ display: "flex", flexDirection: "row", padding: 5 }} onClick={() => {
                ...
                {comment.picurl == null ? <LazyLoadImage style={{ marginBottom: 10, flexShrink: 0.2 }} src={profilephoto} width="50px" height="50px" roundedCircle /> : <Image style={{ marginBottom: 10, flexShrink: 0.2 }} src={comment.picurl} width="50px" height="50px" roundedCircle />}
                <div style={{ flexGrow: 1 }}>
