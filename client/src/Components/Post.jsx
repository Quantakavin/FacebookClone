                      ...
                      return < Carousel.Item >
                        {
                          mediaItem.type == "image" ?
                            <Image width="100%" style={{ marginBottom: 15 }} src={mediaItem.cloudinaryurl} fluid /> :
                            <ReactPlayer width="100%" controls={true} style={{ marginBottom: 15 }} url={mediaItem.cloudinaryurl} />
                        }
                      </Carousel.Item>
                    }
                    )
